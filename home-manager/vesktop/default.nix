...
specialisation.light.configuration = {
    home.activation.set-vesktop-light-theme = config.lib.dag.entryAfter [ "writeBoundary" ] ''
        $DRY_RUN_CMD ln -sf \
...
specialisation.dark.configuration = {
    home.activation.set-vesktop-dark-theme = config.lib.dag.entryAfter [ "writeBoundary" ] ''
        $DRY_RUN_CMD ln -sf \
